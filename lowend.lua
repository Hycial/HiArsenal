...
local PhantomForcesWindow = Library:NewWindow("HiScript.exe")
...
local function API_Check()
        ...
        elseif Errored and not Success then
            ...
            TestService:Message("The boxes script has errored, please notify Hycial with the following information :")
            warn(Errored)
